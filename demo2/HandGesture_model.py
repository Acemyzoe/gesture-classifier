...
import os
for dirname, _, filenames in os.walk('./kaggle/leapgestrecog'):
...
print(y[199],y[399],y[599],y[799],y[999],y[1199],y[1399],y[1599],y[1799],y[1999]) #To debug
...
def validate_gestures(predictions_array, true_label_array, img_array):
 ...
 # class_names = [ "index", "down","ok","palm_moved","palm", "fist_moved","thumb","l", "fist","c"] 
